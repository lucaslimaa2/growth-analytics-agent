...
COLUMN_DESCRIPTIONS: dict[tuple[str, str], str] = {
    ...
    ("customers", "activated_date"): "Date the customer first completed onboarding. NULL if never activated.",
    ("customers", "source"):         "Acquisition source recorded at signup. Values: paid_search, paid_social, organic, referral, outbound.",
    ...
    ("customers", "company_size"):   "Headcount band self-reported at signup. Values: 1-10, 11-50, 51-200, 201-1000, 1000+.",
    ...
    ("subscriptions", "end_reason"):  "Why the subscription ended. Values: voluntary, involuntary_payment, upgrade, downgrade, price_increase, price_increase_migration, outage_followup. NULL if still active.",

    # product_events
    ("product_events", "id"):          "Surrogate primary key.",
    ("product_events", "customer_id"): "References customers.id.",
    ("product_events", "event_name"):  "Event type. Values: page_view, feature_use, report_export, data_import, team_invite, billing_view, dashboard_load, api_call.",
    ...
    ("marketing_spend", "channel"):     "Channel the money was spent on. Values: paid_search, paid_social, outbound.",
    ...
    ("marketing_spend", "conversions"): "Conversions attributed by the ad platform. Not always equal to new_paying_customers in cac_by_channel.",

    # referrals
    ("referrals", "referrer_id"): "Customer who made the referral. References customers.id.",
    ("referrals", "referred_id"): "Customer who was referred and signed up. References customers.id.",
    ...
    ("daily_metrics", "new_paid"):        "Customers who started their first paid subscription on this day.",
    ("daily_metrics", "churned"):         "Paid subscriptions that ended this day (excluding upgrades, downgrades, and price-increase migrations).",
    ...
    ("daily_metrics", "net_new_mrr"):     "gross_new_mrr + expansion_mrr - contraction_mrr - churn_mrr.",
    ("daily_metrics", "dau"):             "Distinct customers who fired any product_event on this day.",
    ("daily_metrics", "mau"):             "Distinct customers who fired any product_event in the calendar month containing this day.",
    ...
    ("cac_by_channel", "new_paying_customers"): "Customers acquired via this channel who started a paid subscription during the month.",
    ("cac_by_channel", "cac_usd"):              "spend_usd / new_paying_customers. NULL when no conversions.",

    # cohort_retention
    ("cohort_retention", "cohort_month"):  "Cohort definition. Month in which the customer first started a paid subscription.",
    ("cohort_retention", "age_months"):    "Months since cohort_month. 0 = first month.",
    ("cohort_retention", "retained_pct"):  "Percent of the original cohort still on a paid subscription at this age.",
