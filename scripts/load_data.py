...
TABLES: list[tuple[str, str, list[str]]] = [
    ...
    ("customers.csv",        "customers",        ["id", "signup_date", "activated_date", "source",
                                                  "channel", "country", "industry", "company_size",
                                                  "initial_plan"]),
    ("subscriptions.csv",    "subscriptions",    ["id", "customer_id", "plan", "mrr_usd",
                                                  "started_at", "ended_at", "end_reason"]),
    ("product_events.csv",   "product_events",   ["id", "customer_id", "event_name", "ts", "properties"]),
    ("marketing_spend.csv",  "marketing_spend",  ["date", "channel", "campaign", "spend_usd",
    ...
    ("daily_metrics.csv",    "daily_metrics",    ["date", "new_signups", "new_activations", "new_paid",
                                                  "churned", "gross_new_mrr", "expansion_mrr",
                                                  "contraction_mrr", "churn_mrr", "net_new_mrr",
                                                  "dau", "mau", "total_paying"]),
    ("monthly_metrics.csv",  "monthly_metrics",  ["month", "mrr_start", "mrr_added", "expansion",
                                                  "contraction", "churn", "mrr_end", "mom_growth_pct",
                                                  "arr", "paying_customers", "arpu",
                                                  "gross_churn_rate", "net_churn_rate"]),
    ("cac_by_channel.csv",   "cac_by_channel",   ["month", "channel", "spend_usd",
                                                  "new_paying_customers", "cac_usd"]),
    ("cohort_retention.csv", "cohort_retention", ["cohort_month", "age_months", "retained_pct",
                                                  "surviving_mrr"]),
]
